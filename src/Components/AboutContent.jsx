    ...
    <section className="flex flex-col items-center justify-center min-h-screen py-4">
      ...
      <div className="flex flex-col justify-center w-9/12">
        ...
        <p>
          ...
          degree in Computer Science, a journey that not only honed my technical
          skills but also deepened my appreciation for the intricacies of
          software development. Before diving into the tech world, I worked in
          HVAC and earned a degree in finance. This diverse background equips me
          with a unique perspective on problem-solving and project management.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          am looking forward to contributing to innovative projects that make a
